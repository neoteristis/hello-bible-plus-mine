...
typedef FocusBuilder = void Function(FocusNode);
...
///
/// The [CustomSelectableText] widget displays a string of text with a single style.
...
/// {@end-tool}
///
/// Using the [SelectableText.rich] constructor, the [CustomSelectableText] widget can
...
/// ## Interactivity
///
/// To make [CustomSelectableText] react to touch events, use callback [onTap] to achieve
...
class _CustomSelectableTextState extends State<CustomSelectableText> implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  Widget build(BuildContext context) {
    ...
    ///Log.info(widget.focusBuilder);
    if(widget.focusBuilder != null){
      Log.info('called');
      widget.focusBuilder!(_effectiveFocusNode);
    }
